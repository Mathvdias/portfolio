...
void main() {
  group('New Window Contents', () {
    testWidgets('AndroidDevWindowContent renders expertise sections', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: Scaffold(body: AndroidDevWindowContent())));
    ...
    testWidgets('ProjectStatsWindowContent renders coverage indicator', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: Scaffold(body: ProjectStatsWindowContent())));
