...
void main() {
  group('ProjectStats Synchronization (Quality Gate)', () {
    test(
      'ProjectStats.coverage and ProjectStats.totalTests are synchronized with repository',
      () {
        ...
        final double expectedCoverage = double.parse(
        ...
        expect(
          ...
          reason:
              'ProjectStats.coverage does not match the coverage computed from coverage/lcov.info.\n'
        ...
        expect(
          ...
          equals(count),
          reason:
              'ProjectStats.totalTests does not match the total tests counted in the test suites.\n'
